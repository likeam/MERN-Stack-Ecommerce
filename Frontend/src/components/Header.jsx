            ...
            <div className=' flexBetween  sm:gap-x-2 bold-16'>
              {!menuOpned ? (
                ...
                <div className=" flexBetween sm:gap-x-6">
                  <NavLink to={"cart"} className={"flex"} > <FaOpencart className=' p-1 h-8 w-8 ring-1 ring-slate-900/30 rounded-full' />
                  ...
                  <NavLink to={'login'} className={' btn_secondary_rounded flexCenter gap-x-2 medium-16'}> <img src={user} className='' alt="loginicon" height={19} width={19} /> Login</NavLink>
                </div>
              </div>
        </div>
    </header>
